...
#### Plots ####
  ...
  mtext(text = expression(Delta*bolditalic('P')*' (mm)'), side = 2, line = 4.6, cex = cex_legend)
  ...
  axis(2, at = seq(0, 250, 50), labels = c(0, "", 100, "", 200, ""), las = 2,
       cex.axis = cex_axis)
  mtext(text = expression(paste(bolditalic("P")," (mm month"^"-1",")")), side = 2, line = 4.6, cex = cex_legend)
  
  # air temp
  par(mar = c(0, 8, 0, 8), new = T)
  ...
  mtext(text = expression(bolditalic("T"[a])*" (°C)"), side = 4, line = 6.5, cex = cex_legend)
  ...
  mtext(text = expression(Delta*bolditalic('T'[a])*' (°C)'), side = 4, line = 6.5, cex = cex_legend)
  abline(h = 0)
  
  ## box
  par(new = T, mfrow = c(1, 1), mgp = c(3, 1, 0), mar = c(3.3, 5.3, 3.3, 5.3))
  ...
  axis(2, at = c(0, 500, 1000, 1500), labels = c(0, 500, 1000, 1500), las = 2,
       cex.axis = cex_axis)
  mtext(text = expression(paste(bolditalic("P")," (mm year"^"-1",")")), side = 2, line = 5.8, cex = cex_legend)
  
  # Temperature
  par(mar = c(0, 9, 1, 9), new = T)
  ...
  mtext(text = expression(bolditalic("T"[a])*" (°C)"), side = 4, line = 8, cex = cex_legend)
  ...
  ## box 
  par(new = T, mfrow = c(1, 1), mgp = c(3, 1, 0), mar = c(3.3, 5.94, 3.3, 5.94))
  plot(0, yaxt = "n", xaxt = "n", ylab = NA , xlab = NA, add = T, ylim = c(-2, -1))
